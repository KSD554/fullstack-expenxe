...
export default function Home() {
  ...
  return (
    <div className="w-full md:w-2/3 flex flex-col gap-4 p-4 mx-auto">
      {/* Solde / Revenus / Dépenses */}
      <div className="flex flex-col sm:flex-row justify-between gap-4 rounded-2xl border-2 border-warning/10 border-dashed bg-warning/5 p-5">
